...
Lukman, Cesar Stuardo, and Riza Suminto \textbf{Scalability Bugs: When 100-Node
Testing is Not Enough}.  To appear in \textit{the 16th Workshop on Hot Topics
in Operating Systems (HotOS)}, 2017 
\vspace{2mm}
...
\begin{tabbing}
\hspace{2.5cm} \= \kill
2014 - 2016 \>\+ \textbf{\textsc{SCk}: Scale-Checking and Debugging Scalability Bugs on One Machine} (In preparation) \\
\begin{minipage}{\smallertextwidth}
...
\begin{tabbing}
\hspace{2.5cm} \= \kill
2016 \>\+ \textbf{PBSE: A Robust Path-Based Speculative Execution} (In submission) \\
\begin{minipage}{\smallertextwidth}
