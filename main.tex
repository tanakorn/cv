...
\begin{tabbing}
\hspace{2.5cm} \= \kill
2017 \>\+ \textbf{PBSE: A Robust Path-Based Speculative Execution} (\textit{\textbf{SoCC '17}}) \\
\begin{minipage}{\smallertextwidth}
...
2018 \> \textbf{Program committee} \> \textit{ATC '18}, USENIX Annual Technical Conference
\end{tabbing}

\begin{tabbing}
\hspace{2.5cm} \= \hspace{5.5cm}  \= \kill
2017 \> \textbf{Shadow program committee} \> \textit{EuroSys '17}, The European Conference on Computer Systems
\end{tabbing}
