...
{\bf Address} \> Microsoft Research\\ % Address line 1
\> 1 Microsoft Way \\ % Address line 2
\> Redmond, WA 98052 \\ % Address line 2
\> \\
...
\job{May 2019 -}{Present}{Research Software Development Engineer}
{Microsoft Research, Redmond, WA, USA}
{\begin{minipage}{\smallertextwidth}
Working on \dblquote{\textit{reliability testing}} project
\end{minipage}}

\job{Aug 2017 -}{May 2019}{Senior Research Engineer}
{Samsung Research America, Mountain View, CA, USA}
{\begin{minipage}{\smallertextwidth}
Worked on \dblquote{\textit{programming abstraction for reliable smart-home applications}} project
\end{minipage}}
...
2019 \> \textbf{Program committee} \> ACM Symposium on Cloud Computing (SoCC '19)
\end{tabbing}

\begin{tabbing}
\hspace{2.5cm} \= \hspace{4.5cm}  \= \kill
2018 \> \textbf{Publicity chair} \> ACM Symposium on Cloud Computing (SoCC '18)
\end{tabbing}
...
\begin{tabbing}
\hspace{2.5cm} \= \hspace{4.5cm}  \= \kill
2015 \> \textbf{External reviewer} \> USENIX Conference on File and Storage Technologies 2018 (FAST '15)
\end{tabbing}
