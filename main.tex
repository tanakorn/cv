...
2018 \> \textbf{Program committee} \> USENIX Annual Technical Conference 2018 (ATC '18)
\end{tabbing}

\begin{tabbing}
\hspace{2.5cm} \= \hspace{4.5cm}  \= \kill
2018 \> \textbf{Shadow program committee} \> The European Conference on Computer Systems 2018 (EuroSys '18)
\end{tabbing}
