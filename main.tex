...
{\begin{minipage}{\smallertextwidth}
Worked on \dblquote{\textit{distributed system reliability testing}} project,
...
Machine}. In \textit{PREPARATION to the Proceedings of the 26th ACM Symposium
...
\textit{PREPARATION to the Proceedings of the USENIX Annual Technical
Conference (ATC)}, 2017
\vspace{2mm}
...
study on distributed concurrency bugs (DC bugs) from four widely-deployed cloud
systems, Cassandra, Hadoop MapReduce, HBase, and ZooKeeper, and introduced a
complete taxonomy of DC bugs in cloud systems.
\end{minipage}
\end{tabbing}
...
knowledge into state-space reduction policies. 
\end{minipage}
\end{tabbing}
...
\textbf{UChicago PhD} \> (3 student) \> Jeffrey F. Lukman, Huan Ke, and Cesar Studardo\\
