...
Worked in \href{https://www.microsoft.com/en-us/research/group/research-in-software-engineering-rise/}{Research in Software Engineering Group (RiSE)} 
...
{University of Chicago, Chicago, IL, USA}
{Work in \href{http://ucare.cs.uchicago.edu/}{UCARE} Group with \href{http://ucare.cs.uchicago.edu/}{Prof. Haryadi S. Gunawi}}

\job{Jun 2014 -}{Aug 2014}{Intern}
{NetApp, Inc., Sunnyvale, CA, USA}
{Worked in \href{http://www.netapp.com/us/company/leadership/advanced-technology/}{Advanced Technology Group (ATG)} with Gokul Soundararajan}
...
\begin{tabbing}
\hspace{2.5cm} \= \kill
2015 \> \href{http://ucare.cs.uchicago.edu/pdf/asplos16-TaxDC.pdf}{\textbf{TaxDC: A Comprehensive Taxonomy of Heisenbugs in Cloud Distributed Systems}} \\
\>\+ (To appear in \textit{ASPLOS '16}) \\
\begin{minipage}{\smallertextwidth}
